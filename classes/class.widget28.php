...
class Owad_Widget extends WP_Widget
{
	...
	function update( $new_instance, $old_instance )
	{
		...
		$set_to_default = true;
		foreach( $new_instance["owad_post_category"]  as $el )
		{
			if ( !empty($el))
		...
		if ( $set_to_default )
		{
			...
			$instance["owad_post_category"] = $owad_default_options["owad_post_category"];
		}
		else
			$instance["owad_post_category"] = $new_instance["owad_post_category"];
		
				
		$instance["owad_daily_post"] = (bool) $new_instance["owad_daily_post"];
		$instance["owad_post_author"] = (int) $new_instance["owad_post_author"];
